      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-700 mb-8">
            Потужний інструмент для створення, редагування та попереднього перегляду кольорових палітр та налаштувань UI
          </p>
          ...
          <div className="mb-8">
            <div className="inline-block bg-amber-100 border border-amber-400 text-amber-800 px-4 py-2 rounded-lg">
              ...
              <p className="text-sm mt-1">
                Ми активно працюємо над покращенням функціоналу. Деякі можливості можуть бути недоступні.
              </p>
            </div>
          </div>
          
          <div className="flex justify-center space-x-4 mb-12">
            <Link href={ROUTES.WIZARD} className="px-6 py-3 bg-indigo-600 text-white rounded-lg shadow-md hover:bg-indigo-700 transition-colors">
              Створити палітру
            </Link>
            <Link href={ROUTES.BROWSE} className="px-6 py-3 bg-white text-indigo-600 border border-indigo-600 rounded-lg shadow-md hover:bg-indigo-50 transition-colors">
        ...
        <div className="mt-16 text-center">
          <h2 className="text-2xl font-semibold text-indigo-700 mb-6">Готові розпочати?</h2>
          <Link href={ROUTES.WIZARD} className="px-8 py-4 bg-indigo-600 text-white rounded-lg shadow-lg hover:bg-indigo-700 transition-colors text-lg font-medium">
